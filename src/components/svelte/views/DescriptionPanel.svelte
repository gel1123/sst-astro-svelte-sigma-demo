...
{#snippet title()}
  <InfoCircle class="text-muted" /> Description
{/snippet}

<Panel initiallyDeployed={true} {title}>
  <p>
    This map represents a <i>network</i> of Wikipedia articles around the topic
    of "Data visualisation". Each{" "}
  ...
  <p>
    ...
    , and then cleaned and enriched manually. This makes the dataset creditable to
    both the médialab team and{" "}
    <a
      target="_blank"
      rel="noreferrer"
  ...
  <p>
    ...
    . More central nodes (ie. bigger nodes) are important crossing points in the
    network. Finally, You can click a node to open the related Wikipedia article.
  </p>
</Panel>
